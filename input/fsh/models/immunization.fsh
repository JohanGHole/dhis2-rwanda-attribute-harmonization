Logical: Immunization
Title: "Immunization"
Description: "Attributes for the 'Immunization' tracker program."
* autoGenChildId 1..1 string "Auto Gen Child ID"
  * ^code[+] = DHIS2Attributes#jKahvk7wiQf
* citizenship 0..1 code "Citizenship"
  * ^code[+] = DHIS2Attributes#VYEGPSgn908
* childId 0..1 string "Child ID (Register number)"
  * ^code[+] = DHIS2Attributes#yBT0DI1TTbT
* nin 0..1 string "NIN"
